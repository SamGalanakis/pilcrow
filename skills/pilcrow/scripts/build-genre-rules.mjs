#!/usr/bin/env node
/**
 * Build script: parse skills/pilcrow/reference/genres/*.md and emit
...
function emit() {
  ...
  const lines = [];
  lines.push("// AUTO-GENERATED by skills/pilcrow/scripts/build-genre-rules.mjs");
  lines.push("// Do not edit by hand. Edit skills/pilcrow/reference/genres/<slug>.md and rerun the build.");
  lines.push("");
